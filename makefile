...
init: up
	...
	docker-compose -f docker-compose.yml -f sentry/docker-compose.yml exec sentry-base sentry createuser --email johny@doe.fr --password aaaaaa --superuser --no-input
